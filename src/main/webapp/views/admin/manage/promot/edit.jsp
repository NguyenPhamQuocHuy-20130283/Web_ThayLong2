...
<%
    Promot promot = (Promot) request.getAttribute("promot");
%>
            ...
            <div class="card card-cascade narrower">
                ...
                <div
                    ...
                    <div>
                        ...
                        <button type="button" onclick="$('form#form').submit()" class="btn btn-outline-white btn-rounded btn-sm px-2">
                                ...
                                <tr>
                                    ...
                                    <td><!-- Material outline counter input -->
                                        <input id="name" type="text" name="name" class="form-control"
                                               value="<%=(promot.getName()!=null)?promot.getName():""%>">
                                        <label for="name"></label>
                                </tr>
                                <tr>
                                    <th>key</th>
                                    <td><input id="key" type="text" name="key" class="form-control"
                                               value="<%=(promot.getKey()!=null)?promot.getKey():""%>">
